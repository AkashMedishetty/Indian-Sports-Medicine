    ...
    <section className="relative bg-[#f5f0eb] py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          >
            Secure your spot at {conferenceConfig.shortName} and be part of the future of excellence
          </motion.p>
          ...
          >
            ...
            >
              <Link
                href="/register"
                className="group px-10 py-5 rounded-full bg-gradient-to-r from-[#fdb246] to-[#fdb246] text-[#0e192b] font-bold text-lg inline-flex items-center gap-3 shadow-2xl shadow-[#fdb246]/50 hover:shadow-[#fdb246]/70 transition-all duration-300"
              >
                Register Now
            ...
            >
              <Link
                href="/pricing"
                className="px-10 py-5 rounded-full bg-white backdrop-blur-xl border-2 border-[#0e192b]/20 text-[#0e192b] font-bold text-lg hover:bg-white/80 hover:border-[#fdb246]/50 transition-all duration-300 inline-block"
              >
                View Pricing
              </Link>
            </motion.div>
