...
// Shader with conference theme colors
const vertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
const fragmentShader = `
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    * buf[7]
    ...
    // Map to conference theme colors - Navy version
    float pattern = buf[0].x * 1.2;
    float detail = buf[0].y * 1.5;
    
    vec3 baseColor = mix(creamColor, primaryColor, pattern);
    vec3 finalColor = mix(baseColor, primaryColor * 0.7, detail);
...
function ShaderPlane() {
  ...
  return (
    <mesh ref={meshRef} position={[0, 0, -1]} scale={[1.2, 1.2, 2]}>
