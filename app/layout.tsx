...
export const metadata: Metadata = {
  ...
  keywords: [
    "IASMCON 2026",
    "IASMCON26",
    "Indian Association of Sports Medicine Conference",
  ...
  publisher: "Indian Association of Sports Medicine (IASM)",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${conferenceConfig.shortName} — Indian Association of Sports Medicine Conference`,
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  twitter: {
    ...
    title: `${conferenceConfig.shortName} - Indian Association of Sports Medicine Conference`,
  ...
  // Favicon is provided by app/icon.svg (IASMCON monogram). ISSH favicons removed.
  verification: {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description: `${conferenceConfig.tagline}. Organized by the Indian Association of Sports Medicine (IASM).`,
